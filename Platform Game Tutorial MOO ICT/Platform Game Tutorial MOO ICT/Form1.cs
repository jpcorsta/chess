...
namespace Platform_Game_Tutorial_MOO_ICT
{
    public partial class Form1 : Form
    {
        ...
        private void MainGameTimerEvent(object sender, EventArgs e)
        {
            ...
            if (verticalPlatform.Top < 92 || verticalPlatform.Top > 462)
            {
            ...
            if (player.Bounds.IntersectsWith(door.Bounds) && score == 26)
            {
                gameTimer.Stop();
                isGameOver = true;
                txtScore.Text = "Score: " + score + Environment.NewLine + "you have finished the game succesfully";
            }
            else
            {
        ...
        private void RestartGame()
        {
            ...
            horizontalPlatform.Left = 216;
            verticalPlatform.Top = 333;
